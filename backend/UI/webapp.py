...
def start_logging():
    global is_logging
    is_logging = True
    logger.run_logger('print_details.hdf5', 'http://143.239.73.224/api/v1/printer', 'backend/UI/_3DBenchy.stl', 'backend/UI/UMS5__3DBenchy.gcode', 0.01)  # This function should contain your while loop logic
