...
def run_logger_with_socket(socketio, hdf5_filename, base_url, camera_url, endpoints, sequence, stl_path, gcode_path, max_duration=None, delay_seconds=0.0):
    global running
    running = True
    ...
    if camera_url and sequence[-1] == '1' :
    ...
    with h5py.File(hdf5_filename, "w") as f:
        ...
        #### HDF5 file architecture preparation
        ...
        while running:
            ...
            #### First scan for calculation of layer
            if first_scan:
            ...
            #### Adjusting layer groups basing on the one done in the First scan + Screenshot capture on layer change
            ...
            #### Request of arbitrary data from printer
            if sequence[0] == '1':
