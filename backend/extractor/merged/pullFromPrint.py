...
gcode_path = '/Users/ob4/Desktop/CS3300-Project/backend/extractor/merged/UMS5__3DBenchy.gcode'
stl_path = '/Users/ob4/Desktop/CS3300-Project/backend/extractor/merged/Harry_Head.stl'
    ...
    with h5py.File("extract_info.hdf5", "w") as f:
        ...
        try:
            while True:
                ...
                bed_current_temp = convert_to_float(bed_info.get("current", 0)) if isinstance(bed_info, dict) else convert_to_float(bed_info)
                bed_target_temp = convert_to_float(bed_info.get("target", 0)) if isinstance(bed_info, dict) else 0.0
                ...
                scan_grp.attrs['position_Z'] = position_xyz[2]
                ...
                print(f'did scan: {scannum}  time: {timestamp:.3f}  position: {position_xyz}   layer: {layer}   last_z: {last_z}')
...
if __name__=="__main__":
    final_layer = log_printer_data()
    print(f"Logging finished. Final layer reached: {final_layer}")